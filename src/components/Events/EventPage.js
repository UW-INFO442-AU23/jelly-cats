...
export default function EventPage(props) {
    ...
    return (
        <div>
            ...
            {/* Event Details */}
            <div className="absolute flex flex-col items-center justify-center p-6 transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-2xl sm:flex-row rounded-2xl top-1/5 left-1/2">
                {/* Event Name + Available Spots */}
                <img src={eventOrgImg} alt="organization" className="w-fit"/>
                <div className="hidden sm:inline-block inline-block h-[145px] min-h-[1em] w-1 bg-gray-200"></div>
                    ...
                    <div className="flex flex-row justify-between px-6">
                        <div id="location" className="flex flex-col max-[750px]:place-self-center">
                            <div className="flex flex-row">
                                ...
                                <p className="font-bold text-xs 2xl:text-xl max-[750px]:text-xs">Location</p>
                            </div>
                            <p className="text-xs 2xl:text-xl max-[750px]:text-xs">{eventData.Location}</p>
                        </div>
                        ...
                        <div id="time" className="flex flex-col max-[750px]:place-self-center">
                            <div className="flex flex-row">
                                ...
                                <p className="font-bold text-xs 2xl:text-xl max-[750px]:text-xs">Time</p>
                            </div>
                            <p className="text-xs 2xl:text-xl max-[750px]:text-xs">{eventData.Time}</p>
                        </div>
                        <div className="inline-block h-[53px] w-0.5 bg-gray-200"></div>
                        <div id="date" className="flex flex-col max-[750px]:place-self-center">
                            <div className="flex flex-row">
                                ...
                                <p className="font-bold text-xs 2xl:text-xl max-[750px]:text-xs">Date</p>
                            </div>
                            <p className="text-xs 2xl:text-xl max-[750px]:text-xs ">{eventData.Date}</p>
                        </div>
                        <div className="inline-block h-[53px] w-0.5 bg-gray-200"></div>
                        <div id="difficulty" className="flex flex-col max-[750px]:place-self-center">
                            <div className="flex flex-row">
                                ...
                                <p className="font-bold text-xs 2xl:text-xl max-[750px]:text-xs">Level</p>
                            </div>
                            <p className="text-xs 2xl:text-xl max-[750px]:text-xs">{eventData["Language Level"]}</p>
                        </div>
                    </div>
                    {/* Event Policy */}
                    <div className="flex flex-row">
                        <input
                            ...
                            className="ml-5 mr-5 md:w-16 md:h-16 md:ml-5 md:mr-5 xl:ml-5 xl:mr-10 xl:w-20 xl:h-20 form-checkbox"
                        />
                        <label htmlFor="myCheckbox" className="text-xs 2xl:text-lg">

...
export default function EventPage(props) {
    ...
    return (
        <>
            ...
            <Breadcrumbs />
            {/* <div className="max-[1250px]:visible min-[1250px]:invisible z-10 flex flex-col col-start-1 row-start-1 text-center text-black">
                        ...
                        <div className="flex flex-row justify-between px-6">
                            <div id="location" className="flex flex-col max-[750px]:place-self-center">
                                <div className="flex flex-row">
                                    ...
                                    <p className="font-bold text-sm xl:text-xl max-[750px]:text-xs">Location</p>
                                </div>
                                <p className="text-sm xl:text-xl max-[750px]:text-xs">{eventData.Location}</p>
                            </div>
                            ...
                            <div id="date" className="flex flex-col max-[750px]:place-self-center">
                                ...
                                <p className="text-sm xl:text-xl max-[750px]:text-xs ">{eventData.Date}</p>
                            </div>
                            <div className="inline-block h-[53px] w-0.5 bg-gray-200"></div>
                            <div id="difficulty" className="flex flex-col max-[750px]:place-self-center">
                                <div className="flex flex-row">
                                    ...
                                    <p className="font-bold text-sm xl:text-xl max-[750px]:text-xs">Level</p>
                                </div>
                                <p className="text-sm xl:text-xl max-[750px]:text-xs">{eventData["Language Level"]}</p>
                            </div>
                        </div>
                        {/* Event Policy */}
            ...
            <div className="flex max-[1250px]:flex-col items-center justify-center gap-5 mb-10 mx-6 md:mx-40 mt-20 flex-row">
                <div className="min-[1250px]:w-1/2 ">
                    {user ? (
                        ...
                        <div className="flex flex-col gap-5">
                            <h2 className="text-base font-bold cursor-pointer md:text-lg lg:text-2xl xl:text-3xl"> Event Description</h2>

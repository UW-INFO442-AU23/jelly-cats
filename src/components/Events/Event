                    ...
                    <div className="flex flex-col justify-center gap-1 md:w-1/2 md:gap-3 lg:gap-6">
                        ...
                        <div className="flex flex-row items-center justify-around md:mx-3 xl:mx-10 xl:mt-5">
                            ...
                            <div className="flex flex-col">
                                <p className="font-bold lg:text-2xl xl:text-3xl">{eventName}</p>
                                <div className="flex flex-row text-indigo-500 xl:mt-2">
                                    <div className="font-bold lg:text-lg xl:text-2xl">{eventData["Spot Limit"] - eventData["Current Attendees"]}</div>
                                    <div className="font-bold lg:mt-1 xl:text-xl">/{eventData["Spot Limit"]}</div>
                                </div>
                            ...
                            <div className="flex flex-col">
                                <div id="date" className="flex max-[750px]:place-self-center">
                                    ...
                                    <p className="text-sm lg:text-lg xl:text-xl max-[750px]:text-xs ">{eventData.Date}</p>
                                </div>
                                <div id="time" className="flex max-[750px]:place-self-center">
                                    ...
                                    <p className="text-sm lg:text-lg xl:text-xl max-[750px]:text-xs">{eventData.Time}</p>
                                </div>
                                <div id="location" className="flex max-[750px]:place-self-center">
                                    ...
                                    <p className="text-sm lg:text-lg xl:text-xl max-[750px]:text-xs">{eventData.Location}</p>
                                </div>
                                <div id="difficulty" className="flex max-[750px]:place-self-center">
                                    ...
                                    <p className="text-sm lg:text-lg xl:text-xl max-[750px]:text-xs">{eventData["Language Level"]}</p>
                                </div>
                            </div>
                        </div>
                        <Link to="/events">
                            <img src={x} alt="close" className="absolute top-0 right-0 m-4 cursor-pointer md:m-2 lg:m-4"/>
                        </Link>
                        {/* Event Description */}
                        <div className="w-full px-5 py-5 text-white bg-indigo-500 lg:px-10 lg:py-10">
                            <p className="text-sm md:text-xs lg:text-base xl:text-lg"><b>Event Description:</b> {eventData.Description}</p>
                        </div>
                        {/* Event Policy */}
                        <div className="flex flex-row xl:px-6">
                            <input
                                ...
                                className="ml-5 mr-5 md:w-16 md:h-16 md:ml-5 md:mr-5 xl:ml-5 xl:mr-10 xl:w-28 xl:h-28 form-checkbox"
                            />
                            <label htmlFor="myCheckbox" className="text-sm md:text-xs lg:text-base xl:text-lg">
                        ...
                        <div>
                            <div className="flex justify-center mb-3 xl:mb-5">
                                {user ? (
                                    ...
                                    <div>
                                        <input type="text" name="email" id="email" onChange={handleEmailChange} className="flex-1 py-2 text-xs text-gray-900 border-2 rounded-md sm:text-sm md:text-xs lg:text-sm placeholder:text-gray-500 w-60 md:w-48 lg:w-60 xl:w-96" placeholder="email@domain.com"/>

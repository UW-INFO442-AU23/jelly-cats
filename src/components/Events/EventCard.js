                            ...
                            <div id="info" className="flex flex-col gap-2">
                                <div id="date" className="flex gap-2 max-[750px]:place-self-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-[16px] h-[16px] my-auto fill-none ">
                                        <path d="M0.808105 5.99827H14.6349M11.5623 9.07197L3.88073 9.07089M6.44122 12.1439L3.88073 12.1435M3.88073 1.38934V2.92565M11.5623 1.38934V2.92565M3.2662 15.2161H12.1768C13.0372 15.2161 13.4675 15.2161 13.7961 15.0487C14.0851 14.9014 14.3202 14.6664 14.4674 14.3773C14.6349 14.0487 14.6349 13.6184 14.6349 12.758V5.38375C14.6349 4.52333 14.6349 4.09313 14.4674 3.76449C14.3202 3.47541 14.0851 3.24039 13.7961 3.0931C13.4675 2.92565 13.0372 2.92565 12.1768 2.92565H3.2662C2.40579 2.92565 1.97558 2.92565 1.64695 3.0931C1.35787 3.24039 1.12284 3.47541 0.975556 3.76449C0.808105 4.09313 0.808105 4.52333 0.808105 5.38375V12.758C0.808105 13.6184 0.808105 14.0487 0.975556 14.3773C1.12284 14.6664 1.35787 14.9014 1.64695 15.0487C1.97558 15.2161 2.40578 15.2161 3.2662 15.2161Z" stroke="white" stroke-width="1.17078" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                    <p className="text-lg max-[750px]:text-xs ">{eventData.Date}</p>
                                </div>
                                <div id="time" className="flex gap-2 max-[750px]:place-self-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-[16px] h-[16px] my-auto fill-none ">
                                        <path d="M7.7215 3.98493V7.8257H10.026M14.6349 7.8257C14.6349 11.6439 11.5397 14.7391 7.7215 14.7391C3.90334 14.7391 0.808105 11.6439 0.808105 7.8257C0.808105 4.00754 3.90334 0.912308 7.7215 0.912308C11.5397 0.912308 14.6349 4.00754 14.6349 7.8257Z" stroke="white" stroke-width="1.17078" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                    <p className="text-lg max-[750px]:text-xs">{eventData.Time}</p>
                                </div>
                                <div id="location" className="flex gap-2 max-[750px]:place-self-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-[16px] h-[16px] my-auto fill-none ">
                                        <path d="M6.18519 15.2621C8.87373 12.4967 11.5623 10.0205 11.5623 6.96598C11.5623 3.91145 9.15488 1.43526 6.18519 1.43526C3.21551 1.43526 0.808105 3.91145 0.808105 6.96598C0.808105 10.0205 3.49665 12.4967 6.18519 15.2621Z" stroke="white" stroke-width="1.17078" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M6.18532 9.1173C7.45808 9.1173 8.48979 8.08559 8.48979 6.81283C8.48979 5.54012 7.45808 4.50837 6.18532 4.50837C4.91257 4.50837 3.88086 5.54012 3.88086 6.81283C3.88086 8.08559 4.91257 9.1173 6.18532 9.1173Z" stroke="white" stroke-width="1.17078" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>

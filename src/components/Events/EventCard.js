    ...
    return (
        <div className="flex justify-center">
            ...
            <div className="flex w-[590px] bg-indigo-500 h-[225px] justify-left p-5 gap-6 rounded-[20px] max-[750px]:flex-col max-[750px]:w-[280px] max-[750px]:h-[425px] max-[750px]:p-4 max-[750px]:gap-4" >
                {/*Img Place Holder */}
                <div id="imgPlaceholder" className="flex justify-center items-center w-48 place-self-center max-[750px]:h-[240px] max-[750px]:rounded-t-lg" >
                    <img src={languageImageSrc} className="object-cover w-full h-full p-1" alt="language"></img>
                </div>
                {/* Event Information */}
                <h1 className="text-sm text-white font-bold text-center min-[750px]:hidden">{eventName}</h1>
                <div id="eventInfo" className="flex gap-10 ml-auto text-white max-[750px]:m-0 max-[750px]:content-center max-[750px]:justify-center max-[750px]:gap-4">
                    {/*Left Column Info (Title, Date, Time, Location, Difficulty) */}
                    <div id="leftColumn" className="flex gap-2.5 flex-col ">
                        <h1 className="text-xl font-bold max-[750px]:text-sm max-[750px]:hidden">{eventName}</h1>

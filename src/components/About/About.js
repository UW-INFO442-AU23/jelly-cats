            ...
            <div className="flex flex-col justify-center">
                ...
                <div className="flex flex-col flex-wrap justify-around md:flex-row md:mx-72">
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="mt-3 font-bold md:text-2xl">Scott Nguyen<br/></p>
                        <p className="mb-3 md:text-xl">Developer</p>
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        <img className="md:w-60" src={matthew} alt="Portrait"/>
                        <p className="mt-3 font-bold md:text-2xl">Matthew Bacarro<br/></p>
                        <p className="mb-3 md:text-xl">Developer</p>
                    </div>
                </div>
            </div>

  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center h-auto">
        ...
        <div className="flex flex-row justify-center my-8 md:my-12">
        ...
        <div className="flex flex-col mx-14 md:mx-60 md:my-10">
          ...
          <p className="md:text-2xl pt-5 md:pt-10 pb-3">1. Review the <Link to="/resources" className="underline">Resources</Link> page for more educational tools to support your learning</p>

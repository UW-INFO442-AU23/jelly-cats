    ...
    return (
        <>
            ...
            <div className="flex flex-col justify-center mt-12">
                {/* Introduction */}
                <div className="flex items-center justify-center my-10 md:flex-row mx-14 md:mx-20 2xl:mx-36">
                ...
                {/* How to use Section */}
                <div className="flex flex-col mx-14 md:mx-32 2xl:mx-60 lg:my-10">
